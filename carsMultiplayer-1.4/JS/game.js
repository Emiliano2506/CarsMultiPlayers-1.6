    ...
    play(){
        ...
        for(var plr in allPlayers){
            ...
            if(this.playerMoving){
                console.log("movimiento del auto 105");
                player.positionY += 10;
                player.update();
            }
 ...
 */
   ...
   /* this.addSprites(
    ...
    handleResetButton(){
        console.log("clic al boton RESET");
